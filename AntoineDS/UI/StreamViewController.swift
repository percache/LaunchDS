...
class StreamViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let streamTitleLabel = UILabel(text: "Launchd")
        ...
        navigationItem.rightBarButtonItems = [
            ...
            UIBarButtonItem(image: UIImage(systemName: "memorychip"),
                          style: .plain, target: self, action: #selector(openKernelLog)),
        ]
        navigationItem.leftBarButtonItems = [
            makeOptionsEditBarButtonItem(),
            UIBarButtonItem(image: UIImage(systemName: "doc.text.fill"),
                          style: .plain, target: self, action: #selector(openSystemLogs)),
        ]
...
extension StreamViewController {
    @objc func scrollAllTheWayDown() {
        ...
        collectionView.scrollToItem(at: IndexPath(row: count - 1, section: 0),
                                    at: .bottom,
                                    animated: true)
	...
	@objc func openSystemLogs() {
		let vc = SystemLogViewController()
		navigationController?.pushViewController(vc, animated: true)
	}

	@objc func openKernelLog() {
		let vc = KernelLogViewController()
		navigationController?.pushViewController(vc, animated: true)
	}
